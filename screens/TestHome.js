...
const TestHome = ({ navigation }) => {
    return (
        ...
        <View style ={styles.intro}>
          <View >
            <Text style={[sharedStyles.TextTitle,{marginTop:20} ]}>{"Test Forum"}</Text>
            <Text style={[{marginTop:20 },sharedStyles.TextRegular]}>Mock Test for</Text>
        ...
        <ScrollView  style ={styles.course} >
          <Pressable style={styles.tabs} onPress={() => navigation.navigate("QATestListScreen")}>
          ...
          <Pressable style={styles.tabs} onPress={() => navigation.navigate("AptiScreen")}>
          ...
          <Pressable style={styles.tabs} onPress={() => navigation.navigate("Home")}>
